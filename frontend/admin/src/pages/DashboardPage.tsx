  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Welcome to your VoltX admin dashboard</p>
      </div>
            ...
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-medium text-gray-900">${(i * 25.50).toFixed(2)}</p>
          ...
          <div className="space-y-3">
            ...
            <button className="w-full text-left p-3 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors">
              <div className="flex items-center">
                ...
                <span className="font-medium text-purple-900">Manage Categories</span>
              </div>
            </button>
            ...
            <button className="w-full text-left p-3 bg-yellow-50 hover:bg-yellow-100 rounded-lg transition-colors">
              <div className="flex items-center">
                ...
                <span className="font-medium text-yellow-900">Create Discount</span>
              </div>
            </button>
          </div>
        </div>
